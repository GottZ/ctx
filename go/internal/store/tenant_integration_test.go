...
func TestTenantScopes_Integration(t *testing.T) {
	...
	t.Run("cross_tenant_read_isolation", func(t *testing.T) {
		...
		gatedByA, err := store.SearchBlocks(ctx, pool, nil, "", aScopes, "", nil, 50, true, nil, nil, nil, nil, nil)
		if err != nil {
		...
		gatedByB, err := store.SearchBlocks(ctx, pool, nil, "", bScopes, "", nil, 50, true, nil, nil, nil, nil, nil)
		if err != nil {
