...
func TestSearchBlocksKeyset_Integration(t *testing.T) {
	...
	page1, err := store.SearchBlocks(ctx, pool, "", []string{scope}, "", nil, pageSize, true, nil, nil, nil, nil, nil)
	if err != nil {
	...
	page2, err := store.SearchBlocks(ctx, pool, "", []string{scope}, "", nil, pageSize, true, cursor, nil, nil, nil, nil)
	if err != nil {
