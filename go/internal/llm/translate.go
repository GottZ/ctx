...
func TranslateQuery(ctx context.Context, host, model, query string) (string, error) {
	resp, err := Chat(ctx, host, model, translationSystemPrompt, query, TranslateOptions(), TranslateTimeout)
	if err != nil {
