...
**Stack:** Go 1.25, PostgreSQL 18 + pgvector 0.8.2, 22 SQL migrations. Inference via any provider (Ollama, Claude, Groq, Gemini — per-pipeline configurable via `CTX_EMBED_*`, `CTX_CHAT_*`, `CTX_DREAM_*` env vars)
